...
entry:
  ...
  store i64 ptrtoint (%0* @data_0x35 to i64), i64* %RDI_val, !mcsema_real_eip !5
  ...
  %uadd = tail call { i64, i1 } @llvm.uadd.with.overflow.i64(i64 %133, i64 16)
  %134 = extractvalue { i64, i1 } %uadd, 0
  %135 = xor i64 %134, %133, !mcsema_real_eip !12
  %136 = and i64 %135, 16
  ...
  %140 = xor i64 %133, -9223372036854775808, !mcsema_real_eip !12
  ...
  store i64 %157, i64* %RSP, !mcsema_real_eip !14
  %158 = load i64, i64* %RBP_val, !mcsema_real_eip !14
  store i64 %158, i64* %RBP, !mcsema_real_eip !14
