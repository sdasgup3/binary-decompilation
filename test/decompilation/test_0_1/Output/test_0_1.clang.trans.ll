...
entry:
  ...
  %78 = extractvalue { i64, i1 } %uadd, 0
  %79 = xor i64 %78, %_new_ptr2int_29, !mcsema_real_eip !6
  %80 = and i64 %79, 16
  %81 = icmp eq i64 %80, 0
  %82 = icmp slt i64 %78, 0
  %83 = icmp eq i64 %78, 0, !mcsema_real_eip !6
  %84 = xor i64 %_new_ptr2int_29, -9223372036854775808, !mcsema_real_eip !6
  %85 = and i64 %79, %84, !mcsema_real_eip !6
  %86 = icmp slt i64 %85, 0
  %87 = trunc i64 %78 to i8, !mcsema_real_eip !6
  %88 = tail call i8 @llvm.ctpop.i8(i8 %87), !mcsema_real_eip !6
  %89 = and i8 %88, 1
  %90 = icmp eq i8 %89, 0
  %91 = extractvalue { i64, i1 } %uadd, 1
  %_new_int2ptr_ = inttoptr i64 %78 to i8*
  store volatile i8* %_new_int2ptr_, i8** %_RSP_ptr_
  %92 = inttoptr i64 %78 to i64*, !mcsema_real_eip !7
  %93 = load i64, i64* %92, !mcsema_real_eip !7
  %_new_int2ptr_30 = inttoptr i64 %93 to i8*
  store volatile i8* %_new_int2ptr_30, i8** %_RBP_ptr_
  %94 = add i64 %78, 16, !mcsema_real_eip !8
  %_new_int2ptr_31 = inttoptr i64 %94 to i8*
  store volatile i8* %_new_int2ptr_31, i8** %_RSP_ptr_
  store i64 0, i64* %RAX, !mcsema_real_eip !8
  store i64 %1, i64* %RBX, !mcsema_real_eip !8
  store i64 0, i64* %RCX, !mcsema_real_eip !8
  store i64 %3, i64* %RDX, !mcsema_real_eip !8
  store i64 %4, i64* %RSI, !mcsema_real_eip !8
  store i64 ptrtoint (%0* @data_0x35 to i64), i64* %RDI, !mcsema_real_eip !8
  store volatile i64 %94, i64* %RSP
  ...
  store i1 %91, i1* %CF, align 1, !mcsema_real_eip !8
  store i1 %90, i1* %PF, align 1, !mcsema_real_eip !8
  store i1 %81, i1* %AF, align 1, !mcsema_real_eip !8
  store i1 %83, i1* %ZF, align 1, !mcsema_real_eip !8
  store i1 %82, i1* %SF, align 1, !mcsema_real_eip !8
  ...
  %95 = load i64, i64* %43, align 4
  store i64 %95, i64* %42, align 4
