...
driverBlockRaw:
  ...
  %78 = add i64 %6, 8, !mcsema_real_eip !6
  store i64 %75, i64* %RAX.i, align 8, !mcsema_real_eip !6
  %79 = bitcast i64* %RBX.i to <2 x i64>*
  store <2 x i64> %2, <2 x i64>* %79, align 8
  %80 = bitcast i64* %RDX.i to <2 x i64>*
  store <2 x i64> %4, <2 x i64>* %80, align 8
  store i64 %5, i64* %RDI.i, align 8, !mcsema_real_eip !6
  store i64 %78, i64* %RSP.i, align 8, !mcsema_real_eip !6
  %81 = bitcast i64* %RBP.i to <2 x i64>*
  store <2 x i64> %8, <2 x i64>* %81, align 8
  %82 = bitcast i64* %R9.i to <2 x i64>*
  store <2 x i64> %10, <2 x i64>* %82, align 8
  %83 = bitcast i64* %R11.i to <2 x i64>*
  store <2 x i64> %12, <2 x i64>* %83, align 8
  %84 = bitcast i64* %R13.i to <2 x i64>*
  store <2 x i64> %14, <2 x i64>* %84, align 8
  ...
  store <2 x i64> %69, <2 x i64>* %85, align 1
