...
driverBlockRaw:
  ...
  %_local_stack_start_ptr_2.i = alloca [80 x i8], align 8
  ...
  %1 = getelementptr inbounds [80 x i8], [80 x i8]* %_local_stack_start_ptr_2.i, i64 0, i64 0
  call void @llvm.lifetime.start(i64 80, i8* nonnull %1)
  %STi_val.i.0..sroa_cast = bitcast [8 x x86_fp80]* %STi_val.i to i8*
  call void @llvm.lifetime.start(i64 128, i8* nonnull %STi_val.i.0..sroa_cast)
  %_local_stack_end_ptr_.i = getelementptr inbounds [80 x i8], [80 x i8]* %_local_stack_start_ptr_2.i, i64 0, i64 80
  ...
  %_new_gep_.i = getelementptr inbounds [80 x i8], [80 x i8]* %_local_stack_start_ptr_2.i, i64 0, i64 72
  ...
  %_new_gep_1.i = getelementptr inbounds [80 x i8], [80 x i8]* %_local_stack_start_ptr_2.i, i64 0, i64 8
  %_trans_p2i_.i = ptrtoint i8* %_new_gep_1.i to i64
  %_trans_xor_.i = xor i64 %_trans_p2i_.i, %64
  %65 = and i64 %_trans_xor_.i, 16, !mcsema_real_eip !3
  %66 = icmp ne i64 %65, 0, !mcsema_real_eip !3
  %_trans_trunc_.i = trunc i64 %_trans_p2i_.i to i8
  %67 = tail call i8 @llvm.ctpop.i8(i8 %_trans_trunc_.i), !mcsema_real_eip !3
  %68 = and i8 %67, 1
  %69 = icmp eq i8 %68, 0
  %_trans_icmp_ne_7.i = icmp ne i8* %_new_gep_.i, inttoptr (i64 64 to i8*)
  %_trans_xor_9.i = and i64 %_trans_xor_.i, %64
  %70 = icmp slt i64 %_trans_xor_9.i, 0
  store volatile i8* %_new_gep_1.i, i8** %_RSP_ptr_.i, align 8
  %_new_gep_11.i = getelementptr inbounds [80 x i8], [80 x i8]* %_local_stack_start_ptr_2.i, i64 0, i64 24
  %71 = ptrtoint i8* %_new_gep_11.i to i64
  %_new_gep_14.i = getelementptr inbounds [80 x i8], [80 x i8]* %_local_stack_start_ptr_2.i, i64 0, i64 68
  %72 = bitcast i8* %_new_gep_14.i to i32*
  store i32 0, i32* %72, align 4, !mcsema_real_eip !4
  %_new_gep_17.i = getelementptr inbounds [80 x i8], [80 x i8]* %_local_stack_start_ptr_2.i, i64 0, i64 16
  %73 = bitcast i8* %_new_gep_17.i to i32*
  store i32 10, i32* %73, align 8, !mcsema_real_eip !5
  %_allin_new_bt_21.i = bitcast i8* %_new_gep_1.i to i64*
  store i64 %71, i64* %_allin_new_bt_21.i, align 8, !mcsema_real_eip !6
  %74 = tail call x86_64_sysvcc i64 @memcpy(i64 %71, i64 ptrtoint (%0* @data_0xb0 to i64), i64 40), !mcsema_real_eip !7
  %_allin_new_bt_29.i = bitcast [80 x i8]* %_local_stack_start_ptr_2.i to i64*
  store i64 -4981261766360305936, i64* %_allin_new_bt_29.i, align 8, !mcsema_real_eip !8
  store volatile i8* %1, i8** %_RSP_ptr_.i, align 8
  store i64 %74, i64* %RAX.i, align 8, !mcsema_real_eip !8
  store i64 %2, i64* %RBX.i, align 8, !mcsema_real_eip !8
  %75 = bitcast i64* %RCX.i to <2 x i64>*
  store <2 x i64> <i64 ptrtoint (%0* @data_0xb0 to i64), i64 40>, <2 x i64>* %75, align 8
  store i64 10, i64* %RSI.i, align 8, !mcsema_real_eip !8
  store i64 %71, i64* %RDI.i, align 8, !mcsema_real_eip !8
  %_new_ptr2int_31.i = ptrtoint [80 x i8]* %_local_stack_start_ptr_2.i to i64
  store volatile i64 %_new_ptr2int_31.i, i64* %RSP.i, align 8
  store volatile i64 %64, i64* %RBP.i, align 8
  %76 = bitcast i64* %R8.i to <2 x i64>*
  store <2 x i64> %4, <2 x i64>* %76, align 8
  %77 = bitcast i64* %R10.i to <2 x i64>*
  store <2 x i64> %6, <2 x i64>* %77, align 8
  %78 = bitcast i64* %R12.i to <2 x i64>*
  store <2 x i64> %8, <2 x i64>* %78, align 8
  %79 = bitcast i64* %R14.i to <2 x i64>*
  store <2 x i64> %10, <2 x i64>* %79, align 8
  store i64 %11, i64* %RIP.i, align 8, !mcsema_real_eip !8
  store i1 %_trans_icmp_ne_7.i, i1* %CF.i, align 1, !mcsema_real_eip !8
  store i1 %69, i1* %PF.i, align 1, !mcsema_real_eip !8
  store i1 %66, i1* %AF.i, align 1, !mcsema_real_eip !8
  store i1 false, i1* %ZF.i, align 1, !mcsema_real_eip !8
  store i1 true, i1* %SF.i, align 1, !mcsema_real_eip !8
  store i1 %70, i1* %OF.i, align 1, !mcsema_real_eip !8
  store i1 %12, i1* %DF.i, align 1, !mcsema_real_eip !8
  call void @llvm.memcpy.p0i8.p0i8.i32(i8* %14, i8* nonnull %STi_val.i.0..sroa_cast, i32 128, i32 8, i1 false), !mcsema_real_eip !8
  ...
  store i11 %45, i11* %FPU_FOPCODE.i, align 1, !mcsema_real_eip !8
  store i128 %46, i128* %XMM0.i, align 1, !mcsema_real_eip !8
  store i128 %47, i128* %XMM1.i, align 1, !mcsema_real_eip !8
  store i128 %48, i128* %XMM2.i, align 1, !mcsema_real_eip !8
  store i128 %49, i128* %XMM3.i, align 1, !mcsema_real_eip !8
  store i128 %50, i128* %XMM4.i, align 1, !mcsema_real_eip !8
  store i128 %51, i128* %XMM5.i, align 1, !mcsema_real_eip !8
  store i128 %52, i128* %XMM6.i, align 1, !mcsema_real_eip !8
  store i128 %53, i128* %XMM7.i, align 1, !mcsema_real_eip !8
  store i128 %54, i128* %XMM8.i, align 1, !mcsema_real_eip !8
  store i128 %55, i128* %XMM9.i, align 1, !mcsema_real_eip !8
  store i128 %56, i128* %XMM10.i, align 1, !mcsema_real_eip !8
  store i128 %57, i128* %XMM11.i, align 1, !mcsema_real_eip !8
  store i128 %58, i128* %XMM12.i, align 1, !mcsema_real_eip !8
  store i128 %59, i128* %XMM13.i, align 1, !mcsema_real_eip !8
  store i128 %60, i128* %XMM14.i, align 1, !mcsema_real_eip !8
  store i128 %61, i128* %XMM15.i, align 1, !mcsema_real_eip !8
  %80 = bitcast i64* %STACK_BASE.i to <2 x i64>*
  store <2 x i64> %63, <2 x i64>* %80, align 1
  call void @llvm.trap()
  unreachable
}
