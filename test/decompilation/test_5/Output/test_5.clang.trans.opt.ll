...
driverBlockRaw:
  ...
  %tmp16.i = xor i1 %74, %76
  br i1 %tmp16.i, label %block_0x25.i.preheader, label %sub_0.exit, !mcsema_real_eip !8

block_0x25.i.preheader:                           ; preds = %driverBlockRaw
  %77 = bitcast i64* %_RBP_ptr_.sroa.0.i to i8**
  br label %block_0x25.i

block_0x25.i:                                     ; preds = %block_0x25.i.preheader, %block_0x25.block_0x25_crit_edge.i
  %78 = phi i32 [ %.pre40.i, %block_0x25.block_0x25_crit_edge.i ], [ 0, %block_0x25.i.preheader ]
  %79 = phi i32 [ %92, %block_0x25.block_0x25_crit_edge.i ], [ 0, %block_0x25.i.preheader ]
  %_RBP_ptr_.sroa.0.0._RBP_ptr_.sroa.0.0._RBP_ptr_.0._load_rbp_ptr_12617.i = phi i8* [ %_RBP_ptr_.sroa.0.i.0._RBP_ptr_.sroa.0.0._RBP_ptr_.sroa.0.0._RBP_ptr_.0._load_rbp_ptr_126.i5, %block_0x25.block_0x25_crit_edge.i ], [ %_new_gep_.i, %block_0x25.i.preheader ]
  %80 = sext i32 %79 to i64, !mcsema_real_eip !9
  %_new_gep_22.i = getelementptr i8, i8* %_RBP_ptr_.sroa.0.0._RBP_ptr_.sroa.0.0._RBP_ptr_.0._load_rbp_ptr_12617.i, i64 -8
  %_allin_new_bt_23.i = bitcast i8* %_new_gep_22.i to i64*
  %81 = load i64, i64* %_allin_new_bt_23.i, align 8, !mcsema_real_eip !10
  %82 = shl nsw i64 %80, 2
  %83 = add i64 %81, %82, !mcsema_real_eip !11
  %84 = inttoptr i64 %83 to i32*
  %85 = load i32, i32* %84, align 4, !mcsema_real_eip !11
  %_new_gep_25.i = getelementptr i8, i8* %_RBP_ptr_.sroa.0.0._RBP_ptr_.sroa.0.0._RBP_ptr_.0._load_rbp_ptr_12617.i, i64 -16
  %86 = bitcast i8* %_new_gep_25.i to i32*
  %87 = add i32 %85, %78
  store i32 %87, i32* %86, align 4, !mcsema_real_eip !12
  %_RBP_ptr_.sroa.0.i.0._RBP_ptr_.sroa.0.0._RBP_ptr_.sroa.0.0._RBP_ptr_.0._load_rbp_ptr_307.i4 = load i8*, i8** %77, align 8
  %_new_gep_31.i = getelementptr i8, i8* %_RBP_ptr_.sroa.0.i.0._RBP_ptr_.sroa.0.0._RBP_ptr_.sroa.0.0._RBP_ptr_.0._load_rbp_ptr_307.i4, i64 -20
  %88 = bitcast i8* %_new_gep_31.i to i32*
  %89 = load i32, i32* %88, align 4, !mcsema_real_eip !13
  %90 = add i32 %89, 1
  store i32 %90, i32* %88, align 4, !mcsema_real_eip !14
  %_RBP_ptr_.sroa.0.i.0._RBP_ptr_.sroa.0.0._RBP_ptr_.sroa.0.0._RBP_ptr_.0._load_rbp_ptr_126.i5 = load i8*, i8** %77, align 8
  %_new_gep_13.i = getelementptr i8, i8* %_RBP_ptr_.sroa.0.i.0._RBP_ptr_.sroa.0.0._RBP_ptr_.sroa.0.0._RBP_ptr_.0._load_rbp_ptr_126.i5, i64 -20
  %91 = bitcast i8* %_new_gep_13.i to i32*
  %92 = load i32, i32* %91, align 4, !mcsema_real_eip !15
  %_new_gep_16.i = getelementptr i8, i8* %_RBP_ptr_.sroa.0.i.0._RBP_ptr_.sroa.0.0._RBP_ptr_.sroa.0.0._RBP_ptr_.0._load_rbp_ptr_126.i5, i64 -12
  ...
  %tmp.i = xor i1 %97, %100
  br i1 %tmp.i, label %block_0x25.block_0x25_crit_edge.i, label %block_0x19.block_0x48_crit_edge.i, !mcsema_real_eip !8

block_0x25.block_0x25_crit_edge.i:                ; preds = %block_0x25.i
  %_new_gep_25.phi.trans.insert.i = getelementptr i8, i8* %_RBP_ptr_.sroa.0.i.0._RBP_ptr_.sroa.0.0._RBP_ptr_.sroa.0.0._RBP_ptr_.0._load_rbp_ptr_126.i5, i64 -16
  %.phi.trans.insert.i = bitcast i8* %_new_gep_25.phi.trans.insert.i to i32*
  %.pre40.i = load i32, i32* %.phi.trans.insert.i, align 4
  br label %block_0x25.i

block_0x19.block_0x48_crit_edge.i:                ; preds = %block_0x25.i
  %101 = zext i32 %85 to i64, !mcsema_real_eip !11
  %102 = zext i32 %87 to i64, !mcsema_real_eip !16
  ...
  %_new_gep_36.phi.trans.insert.i = getelementptr i8, i8* %_RBP_ptr_.sroa.0.i.0._RBP_ptr_.sroa.0.0._RBP_ptr_.sroa.0.0._RBP_ptr_.0._load_rbp_ptr_126.i5, i64 -16
  %.phi.trans.insert41.i = bitcast i8* %_new_gep_36.phi.trans.insert.i to i32*
  %.pre42.i = load i32, i32* %.phi.trans.insert41.i, align 4
  %phitmp.i = zext i32 %.pre42.i to i64
  br label %sub_0.exit

sub_0.exit:                                       ; preds = %driverBlockRaw, %block_0x19.block_0x48_crit_edge.i
  %103 = phi i64 [ %phitmp.i, %block_0x19.block_0x48_crit_edge.i ], [ 0, %driverBlockRaw ]
  %104 = phi i64 [ %.pre.i, %block_0x19.block_0x48_crit_edge.i ], [ %_RBP_ptr_.sroa.0.i.0._RBP_ptr_.sroa.0.0._RBP_ptr_.sroa.0.0._RBP_ptr_.0._load_rbp_ptr_2.i, %driverBlockRaw ]
  ...
  %RCX_val.0.lcssa.i = phi i64 [ %81, %block_0x19.block_0x48_crit_edge.i ], [ %3, %driverBlockRaw ]
  %.lcssa12.i = phi i32 [ %92, %block_0x19.block_0x48_crit_edge.i ], [ 0, %driverBlockRaw ]
  %.lcssa11.i = phi i32 [ %94, %block_0x19.block_0x48_crit_edge.i ], [ %69, %driverBlockRaw ]
  %.lcssa10.i = phi i32 [ %95, %block_0x19.block_0x48_crit_edge.i ], [ %73, %driverBlockRaw ]
  %.lcssa9.i = phi i32 [ %96, %block_0x19.block_0x48_crit_edge.i ], [ %73, %driverBlockRaw ]
  %.lcssa8.i = phi i1 [ %97, %block_0x19.block_0x48_crit_edge.i ], [ %74, %driverBlockRaw ]
  %.lcssa.i = phi i1 [ %100, %block_0x19.block_0x48_crit_edge.i ], [ %76, %driverBlockRaw ]
  %105 = icmp ult i32 %.lcssa12.i, %.lcssa11.i, !mcsema_real_eip !7
  %106 = icmp eq i32 %.lcssa12.i, %.lcssa11.i
  %107 = trunc i32 %.lcssa10.i to i8, !mcsema_real_eip !7
  %108 = tail call i8 @llvm.ctpop.i8(i8 %107) #2, !mcsema_real_eip !7
  %109 = and i8 %108, 1
  %110 = icmp eq i8 %109, 0
  %111 = xor i32 %.lcssa9.i, %.lcssa11.i, !mcsema_real_eip !7
  %112 = and i32 %111, 16, !mcsema_real_eip !7
  %113 = icmp ne i32 %112, 0, !mcsema_real_eip !7
  store volatile i64 %104, i64* %_RBP_ptr_.sroa.0.i, align 8
  ...
  store i64 %103, i64* %RAX.i, align 8, !mcsema_real_eip !17
  ...
  store i64 %6, i64* %RDI.i, align 8, !mcsema_real_eip !17
  %_new_ptr2int_42.i = ptrtoint i8* %_new_gep_40.i to i64
  store volatile i64 %_new_ptr2int_42.i, i64* %RSP.i, align 8
  store volatile i64 %104, i64* %RBP.i, align 8
  %114 = bitcast i64* %R8.i to <2 x i64>*
  store <2 x i64> %8, <2 x i64>* %114, align 8
  %115 = bitcast i64* %R10.i to <2 x i64>*
  store <2 x i64> %10, <2 x i64>* %115, align 8
  %116 = bitcast i64* %R12.i to <2 x i64>*
  store <2 x i64> %12, <2 x i64>* %116, align 8
  %117 = bitcast i64* %R14.i to <2 x i64>*
  store <2 x i64> %14, <2 x i64>* %117, align 8
  store i64 %15, i64* %RIP.i, align 8, !mcsema_real_eip !17
  store i1 %105, i1* %CF.i, align 1, !mcsema_real_eip !17
  store i1 %110, i1* %PF.i, align 1, !mcsema_real_eip !17
  store i1 %113, i1* %AF.i, align 1, !mcsema_real_eip !17
  store i1 %106, i1* %ZF.i, align 1, !mcsema_real_eip !17
  store i1 %.lcssa8.i, i1* %SF.i, align 1, !mcsema_real_eip !17
  ...
  %118 = bitcast i64* %STACK_BASE.i to <2 x i64>*
  store <2 x i64> %67, <2 x i64>* %118, align 1
