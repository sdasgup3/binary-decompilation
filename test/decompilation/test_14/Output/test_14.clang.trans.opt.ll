...
driverBlockRaw:
  ...
  %_allin_new_bt_15.i = bitcast [24 x i8]* %_local_stack_start_ptr_1.i to i64*
  store i64 ptrtoint (%0* @data_0x45 to i64), i64* %_allin_new_bt_15.i, align 8, !mcsema_real_eip !4
  %70 = tail call x86_64_sysvcc i64 @strcmp(i64 %6, i64 ptrtoint (%0* @data_0x45 to i64)), !mcsema_real_eip !5
  %uadd.i = tail call { i64, i1 } @llvm.uadd.with.overflow.i64(i64 %69, i64 16)
  %71 = extractvalue { i64, i1 } %uadd.i, 0
  %72 = xor i64 %71, %69, !mcsema_real_eip !6
  %73 = and i64 %72, 16
  %74 = icmp eq i64 %73, 0
  %75 = icmp slt i64 %71, 0
  %76 = icmp eq i64 %71, 0, !mcsema_real_eip !6
  %77 = xor i64 %69, -9223372036854775808, !mcsema_real_eip !6
  %78 = and i64 %72, %77, !mcsema_real_eip !6
  %79 = icmp slt i64 %78, 0
  %80 = trunc i64 %71 to i8, !mcsema_real_eip !6
  %81 = tail call i8 @llvm.ctpop.i8(i8 %80), !mcsema_real_eip !6
  %82 = and i8 %81, 1
  %83 = icmp eq i8 %82, 0
  %84 = extractvalue { i64, i1 } %uadd.i, 1
  store volatile i64 %71, i64* %_RSP_ptr_.sroa.0.i, align 8
  %85 = inttoptr i64 %71 to i64*, !mcsema_real_eip !7
  %86 = load i64, i64* %85, align 8
  store volatile i64 %86, i64* %_RBP_ptr_.sroa.0.i, align 8
  %87 = add i64 %71, 16, !mcsema_real_eip !8
  store volatile i64 %87, i64* %_RSP_ptr_.sroa.0.i, align 8
  store i64 %70, i64* %RAX.i, align 8, !mcsema_real_eip !8
  %88 = bitcast i64* %RBX.i to <2 x i64>*
  store <2 x i64> %4, <2 x i64>* %88, align 8
  store i64 %5, i64* %RDX.i, align 8, !mcsema_real_eip !8
  store i64 ptrtoint (%0* @data_0x45 to i64), i64* %RSI.i, align 8, !mcsema_real_eip !8
  store i64 %6, i64* %RDI.i, align 8, !mcsema_real_eip !8
  store volatile i64 %87, i64* %RSP.i, align 8
  ...
  store i1 %84, i1* %CF.i, align 1, !mcsema_real_eip !8
  store i1 %83, i1* %PF.i, align 1, !mcsema_real_eip !8
  store i1 %74, i1* %AF.i, align 1, !mcsema_real_eip !8
  store i1 %76, i1* %ZF.i, align 1, !mcsema_real_eip !8
  store i1 %75, i1* %SF.i, align 1, !mcsema_real_eip !8
  store i1 %79, i1* %OF.i, align 1, !mcsema_real_eip !8
