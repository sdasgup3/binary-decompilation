...
@data_0x45 = internal constant %0 <{ [4 x i8] c"foo\00" }>, align 64
...
entry:
  ...
  store i64 ptrtoint (%0* @data_0x45 to i64), i64* %_allin_new_bt_15, !mcsema_real_eip !4
  %_load_rbp_ptr_16 = load i8*, i8** %_RBP_ptr_
  %_new_gep_17 = getelementptr i8, i8* %_load_rbp_ptr_16, i64 -8
  %_allin_new_bt_18 = bitcast i8* %_new_gep_17 to i64*
  %68 = load i64, i64* %_allin_new_bt_18, !mcsema_real_eip !5
  %_new_gep_19 = getelementptr i8, i8* %_load_rbp_ptr_16, i64 -16
  %_allin_new_bt_20 = bitcast i8* %_new_gep_19 to i64*
  %69 = load i64, i64* %_allin_new_bt_20, !mcsema_real_eip !6
  %70 = tail call x86_64_sysvcc i64 @strcmp(i64 %68, i64 %69), !mcsema_real_eip !7
  %_load_rsp_ptr_21 = load i8*, i8** %_RSP_ptr_
  %_new_ptr2int_22 = ptrtoint i8* %_load_rsp_ptr_21 to i64
  %uadd = tail call { i64, i1 } @llvm.uadd.with.overflow.i64(i64 %_new_ptr2int_22, i64 16)
  %71 = extractvalue { i64, i1 } %uadd, 0
  %72 = xor i64 %71, %_new_ptr2int_22, !mcsema_real_eip !8
  %73 = and i64 %72, 16
  %74 = icmp eq i64 %73, 0
  %75 = icmp slt i64 %71, 0
  %76 = icmp eq i64 %71, 0, !mcsema_real_eip !8
  %77 = xor i64 %_new_ptr2int_22, -9223372036854775808, !mcsema_real_eip !8
  ...
  %_new_int2ptr_23 = inttoptr i64 %86 to i8*
  store volatile i8* %_new_int2ptr_23, i8** %_RBP_ptr_
  %87 = add i64 %71, 16, !mcsema_real_eip !10
  %_new_int2ptr_24 = inttoptr i64 %87 to i8*
  store volatile i8* %_new_int2ptr_24, i8** %_RSP_ptr_
  store i64 %70, i64* %RAX, !mcsema_real_eip !10
  store i64 %1, i64* %RBX, !mcsema_real_eip !10
  store i64 %2, i64* %RCX, !mcsema_real_eip !10
  store i64 %3, i64* %RDX, !mcsema_real_eip !10
  store i64 %69, i64* %RSI, !mcsema_real_eip !10
  store i64 %68, i64* %RDI, !mcsema_real_eip !10
  ...
  store i64 %5, i64* %R8, !mcsema_real_eip !10
  store i64 %6, i64* %R9, !mcsema_real_eip !10
  store i64 %7, i64* %R10, !mcsema_real_eip !10
  store i64 %8, i64* %R11, !mcsema_real_eip !10
  store i64 %9, i64* %R12, !mcsema_real_eip !10
  store i64 %10, i64* %R13, !mcsema_real_eip !10
  store i64 %11, i64* %R14, !mcsema_real_eip !10
  store i64 %12, i64* %R15, !mcsema_real_eip !10
  store i64 %13, i64* %RIP, !mcsema_real_eip !10
  ...
  store i1 %14, i1* %DF, align 1, !mcsema_real_eip !10
  call void @llvm.memcpy.p0i8.p0i8.i32(i8* %16, i8* %17, i32 128, i32 8, i1 false), !mcsema_real_eip !10
  store i1 %18, i1* %FPU_B, align 1, !mcsema_real_eip !10
  store i1 %19, i1* %FPU_C3, align 1, !mcsema_real_eip !10
  store i3 %20, i3* %FPU_TOP, align 1, !mcsema_real_eip !10
  store i1 %21, i1* %FPU_C2, align 1, !mcsema_real_eip !10
  store i1 %22, i1* %FPU_C1, align 1, !mcsema_real_eip !10
  store i1 %23, i1* %FPU_C0, align 1, !mcsema_real_eip !10
  store i1 %24, i1* %FPU_ES, align 1, !mcsema_real_eip !10
  store i1 %25, i1* %FPU_SF, align 1, !mcsema_real_eip !10
  store i1 %26, i1* %FPU_PE, align 1, !mcsema_real_eip !10
  store i1 %27, i1* %FPU_UE, align 1, !mcsema_real_eip !10
  store i1 %28, i1* %FPU_OE, align 1, !mcsema_real_eip !10
  store i1 %29, i1* %FPU_ZE, align 1, !mcsema_real_eip !10
  store i1 %30, i1* %FPU_DE, align 1, !mcsema_real_eip !10
  store i1 %31, i1* %FPU_IE, align 1, !mcsema_real_eip !10
  store i1 %32, i1* %FPU_X, align 1, !mcsema_real_eip !10
  store i2 %33, i2* %FPU_RC, align 1, !mcsema_real_eip !10
  store i2 %34, i2* %FPU_PC, align 1, !mcsema_real_eip !10
  store i1 %35, i1* %FPU_PM, align 1, !mcsema_real_eip !10
  store i1 %36, i1* %FPU_UM, align 1, !mcsema_real_eip !10
  store i1 %37, i1* %FPU_OM, align 1, !mcsema_real_eip !10
  store i1 %38, i1* %FPU_ZM, align 1, !mcsema_real_eip !10
  store i1 %39, i1* %FPU_DM, align 1, !mcsema_real_eip !10
  store i1 %40, i1* %FPU_IM, align 1, !mcsema_real_eip !10
  %88 = load i64, i64* %43, align 4
  store i64 %88, i64* %42, align 4
  store i16 %45, i16* %FPU_LASTIP_SEG, align 1, !mcsema_real_eip !10
  store i64 %46, i64* %FPU_LASTIP_OFF, align 1, !mcsema_real_eip !10
  store i16 %47, i16* %FPU_LASTDATA_SEG, align 1, !mcsema_real_eip !10
  store i64 %48, i64* %FPU_LASTDATA_OFF, align 1, !mcsema_real_eip !10
  store i11 %49, i11* %FPU_FOPCODE, align 1, !mcsema_real_eip !10
  store i128 %50, i128* %XMM0, align 1, !mcsema_real_eip !10
  store i128 %51, i128* %XMM1, align 1, !mcsema_real_eip !10
  store i128 %52, i128* %XMM2, align 1, !mcsema_real_eip !10
  store i128 %53, i128* %XMM3, align 1, !mcsema_real_eip !10
  store i128 %54, i128* %XMM4, align 1, !mcsema_real_eip !10
  store i128 %55, i128* %XMM5, align 1, !mcsema_real_eip !10
  store i128 %56, i128* %XMM6, align 1, !mcsema_real_eip !10
  store i128 %57, i128* %XMM7, align 1, !mcsema_real_eip !10
  store i128 %58, i128* %XMM8, align 1, !mcsema_real_eip !10
  store i128 %59, i128* %XMM9, align 1, !mcsema_real_eip !10
  store i128 %60, i128* %XMM10, align 1, !mcsema_real_eip !10
  store i128 %61, i128* %XMM11, align 1, !mcsema_real_eip !10
  store i128 %62, i128* %XMM12, align 1, !mcsema_real_eip !10
  store i128 %63, i128* %XMM13, align 1, !mcsema_real_eip !10
  store i128 %64, i128* %XMM14, align 1, !mcsema_real_eip !10
  store i128 %65, i128* %XMM15, align 1, !mcsema_real_eip !10
  store i64 %66, i64* %STACK_BASE, align 1, !mcsema_real_eip !10
  store i64 %67, i64* %STACK_LIMIT, align 1, !mcsema_real_eip !10
